  ...
  basePaths.forEach(basePath =>
    describe(`basePath: ${basePath || '[none]'}`, () => {
      ...
      [
        {
          title: 'for images',
          path: '/vendor/v1/images/gov.uk_logotype_crown_invert_trans.png',
        },
        ...
        describe(d.title, () => {
          ...
          it('should send correct Cache-Control header', () =>
            expect(this.response.headers)
              .to.have.property('cache-control', 'public, max-age=3153600')
          );
